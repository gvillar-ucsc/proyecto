    ...
    <div class="container">
        ...
        <table class="table table-striped">
            <thead>
                ...
                <th class='text-center' scope="col">Cantidad de Personal</th>
            ...
            <tbody>
                    <?php
                        ...
                        while($row=mysqli_fetch_assoc($resultado)){
                            ...
                            echo "<tr>";
                            echo "<td class='text-center'>" .$ubicacion. "</td>";
                            echo "<td class='text-center'>" .$personas. "</td>";
                            echo "<td class='text-center'><a href='../Estadistics/VerGrafico.php?ubicacion=".$id_stat."'>Observar Gráfico</a></td>";
                            echo "</tr>";
                        }
                    ?>
            </tbody>
