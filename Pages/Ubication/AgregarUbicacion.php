...
if (isset($_POST['Guardar'])) {
    ...
    $calle_ubi = $_POST['calle_ubi'];

    $consulta = "INSERT into ubicacion (nombre_ubi, calle_ubi) VALUES ('$nombre_ubi', '$calle_ubi')";
    ...
    <div class="container mt-5">
        <form action="" method="POST" class="w-50 mx-auto">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" name="calle_ubi">
                </div>
            </div>
            <div class="text-center">
                <button type="submit" name="Guardar" class="btn btn-primary">Guardar Ubicacion</button>
