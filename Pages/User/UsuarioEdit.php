...
if (isset($_POST['Editar'])) {
  ...
  $consulta = "UPDATE usuarios SET nombre_u='$usuario',categoria_u='$categoria_u'WHERE id_u='$id_ud'";
    ...
    <div class="container mt-5">
        <form action="" method="POST" class="w-50 mx-auto">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" name="nombre_u" value="<?php echo $usuario; ?>">
                </div>
            </div>
            <div class="row mb-3">
